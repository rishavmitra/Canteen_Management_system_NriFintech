...
public class UpcomingOrdersExcelGenerator {
    public void generate(List<OrderEntity> orderslist, HttpServletResponse response) throws IOException {
        ...
        // Setting the Title
        int rowNum=1;
        titleCell.setCellValue("List of the Upcoming Orders - " + dtf.format(now));
